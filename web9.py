...
def get_movie_list_details():
    movie_list = []
    for i in movie:
        path = "/home/dell38/Desktop/web scriping/alltext_moviedata1/allmovies.text" + i["Name"] + ".text"
        random_sleep = random.randint(1,3)
        if os.path.exists("file.json"):
            pass
        else:
            create = open("/home/dell38/Desktop/web scriping/alltext_moviedata1/allmovies.text" + i["Name"] + ".text","w")
